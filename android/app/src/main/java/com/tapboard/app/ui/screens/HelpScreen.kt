        ...
        Column(
            ...
            Section(
                ...
                "1. On your PC/TV, open Bluetooth settings and stay discoverable.\n" +
                    ...
                    "3. In TapBoard → Refresh → Connect.\n" +
                    "4. Accept the HID connection on the host if prompted."
            )
            Section(
                "If Bluetooth HID fails",
                "Some phone makers limit acting as a Bluetooth keyboard. TapBoard will show an error. " +
                    "This is normal on many OEM stacks — try another host device or check that Bluetooth is on and the host is paired."
            )
            Spacer(modifier = Modifier.height(8.dp))
            Section(
                "Privacy",
                "TapBoard does not create accounts or upload your input. Bluetooth identifiers stay on your devices."
            )
            OutlinedButton(
            ...
            Spacer(modifier = Modifier.height(8.dp))
            OutlinedButton(
                onClick = { open(TapBoardLinks.GITHUB_REPO) },
                modifier = Modifier.fillMaxWidth()
            ) {
                Text("GitHub")
            }
